...
--
local function makeToggle(name, initialValue, callback)
    return {
        toggleHolder = toggleHolder,
        toggleTitle = toggleTitle,
        toggleButton = toggleButton,
        toggleStateIndicator = toggleStateIndicator
    }
end
...
function sections:configloader(props)
	...
	local configloader = {}
	-- // main
    local section1 = makeSection("Section 1")
    local toggle1 = makeToggle("Toggle 1", false, function(state)
        print("toggle modification 1")
    end)

    local toggle2 = makeToggle("Toggle 2", true, function(state)
        print("toggle modification 2")
    end)

    section1.toggles[#section1.toggles + 1] = toggle1
    section1.toggles[#section1.toggles + 1] = toggle2
