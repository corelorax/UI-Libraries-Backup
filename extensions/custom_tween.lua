-- custom tween
--// Credits: https://github.com/vozoid <-- it's vozoid babyyy!

local Signal = loadstring(game:HttpGet("https://raw.githubusercontent.com/corelorax/Events/refs/heads/main/API%2BSignals.lua"))()
