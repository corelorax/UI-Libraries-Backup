...
local library = {
    ...
    signal      = loadstring(game:HttpGetAsync('https://raw.githubusercontent.com/corelorax/Events/main/Signal%232.lua'))(),
    stat        = {fps = 0, ping = 0},
    drawings    = {
        active    = {},
        draggable = {},
...
function library:create_settings_tab(menu)
    ...
    settings_main:keybind({text = 'open / close', flag = 'menubind', default = Enum.KeyCode.RightControl, callback = function(bool)
